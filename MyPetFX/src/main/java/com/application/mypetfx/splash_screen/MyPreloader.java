...
public class MyPreloader extends Preloader {
    ...
    public void handleApplicationNotification(Preloader.PreloaderNotification info) {
        ...
        if (info instanceof ProgressNotification) {
            SplashScreenController.setLabel("Loading " + (int) (((ProgressNotification) info).getProgress() * 100) + "%");
            SplashScreenController.setStatProgressBar(((ProgressNotification) info).getProgress());
        }
