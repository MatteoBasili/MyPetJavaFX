...
public class RegistrationInteractor {
    ...
    public void registerAccount(RegistrationCredentials registrationCredentials) {
        ...
        if (registrationCredentials.getSystemUserData().isPetSitter()) {
            if (hasPetSitterError(registrationCredentials.getPetSitterCaredPets(), registrationCredentials.getPetSitterServices())) {
                return;
            }
        }
    ...
    private boolean hasInputError(RegistrationCredentials registrationCredentials) {
        ...
        try {
            ...
            if (province.equals("Select your province")) {
