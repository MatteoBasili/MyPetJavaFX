...
public class PetSitterResultsSingletonClass {
    ...
    private List<PetSitProfileInfo> petSitProfileInfos;
    ...
    public List<PetSitProfileInfo> getPetSitProfileInfos() {
        return petSitProfileInfos;
    }

    public void setPetSitProfileInfos(List<PetSitProfileInfo> petSitProfileInfos) {
