...
public class PetSitProfileController implements Initializable, ProfileContract.PetSitProfileView {
    ...
    public void onLoadProfileSuccess(PetSitProfileInfo petSitProfileInfo) {
        if (petSitProfileInfo.getImage() != null) {
            profileImage.setImage(petSitProfileInfo.getImage());
            profileImageSingletonClass.setImage(petSitProfileInfo.getImage());
            pictureFrame.setCursor(Cursor.HAND);
        } else {
            defaultProfileImage.setVisible(true);
            profileImageSingletonClass.setImage(null);
        ...
        likes.setText(String.valueOf(petSitProfileInfo.getNumLikes()));
        dislikes.setText(String.valueOf(petSitProfileInfo.getNumDislikes()));
    }
