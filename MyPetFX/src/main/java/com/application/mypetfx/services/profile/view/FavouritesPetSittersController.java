...
import com.application.mypetfx.services.profile.PersonalFavPetSitPresenter;
...
public class FavouritesPetSittersController implements Initializable, ProfileContract.LoadFavPetView {
    ...
    private static final Logger logger = Logger.getLogger(FavouritesPetSittersController.class);
    ...
    private PersonalFavPetSitPresenter presenter;
    private Node[] items;

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        userSingletonClass = UserSingletonClass.getSingletonInstance();
        presenter = new PersonalFavPetSitPresenter(this);
