    ...
    private PetSitterDetails loadFromDB(String user, String petSitter, Connection connection) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                petSitProfileInfo.setNumLikes(rs.getInt("Likes"));
                petSitProfileInfo.setNumDislikes(rs.getInt("Dislikes"));
            ...
            petSitterDetails.setLoadPetSitProfileInfo(petSitProfileInfo);
