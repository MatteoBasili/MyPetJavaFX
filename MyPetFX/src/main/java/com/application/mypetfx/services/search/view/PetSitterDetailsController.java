...
public class PetSitterDetailsController implements Initializable, PetSitterSearchContract.PetSitterDetailsView, PetSitterSearchContract.PetSitterFavoritesView,
    ...
    @FXML
    private CheckBox serviceBox1;
    @FXML
    private CheckBox serviceBox2;
    @FXML
    private CheckBox serviceBox3;
    @FXML
    private CheckBox serviceBox4;
    @FXML
    private CheckBox serviceBox5;
    @FXML
    ...
    public void onSetFavoriteSuccess() {
        if (noFavoritesIcon.isVisible()) {
            ...
            updateFavoriteToResultList(true);
        } else {
            noFavoritesIcon.setVisible(true);
            favoritesIcon.setVisible(false);
            // View the change of favorite state also in the list
            updateFavoriteToResultList(false);
        }
    }

    private void updateFavoriteToResultList(boolean bool) {
        petSitterResultsSingletonClass.getFavorites().set(positionInList, bool);
    }
    ...
    public void onLoadDetailsSuccess(PetSitterDetails petSitterDetails) {
        ...
        // Load services
        serviceBox1.setSelected(petSitterDetails.getPetSitServices().isServ1());
        serviceBox2.setSelected(petSitterDetails.getPetSitServices().isServ2());
        serviceBox3.setSelected(petSitterDetails.getPetSitServices().isServ3());
        serviceBox4.setSelected(petSitterDetails.getPetSitServices().isServ4());
        serviceBox5.setSelected(petSitterDetails.getPetSitServices().isServ5());
